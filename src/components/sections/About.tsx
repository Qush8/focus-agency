            ...
            <div className="w-[90%] mt-[10px] flex flex-col ">
                ...
                >
                    ...
                    <div className="flex justify-between items-center w-full">
                        ...
                        <div className={`about-arrow-${index}`}>
                            <img 
                                src="/icons/arrow.svg" 
                                alt="Expand" 
                                className={`w-[18px] h-[24px] transition-all duration-300 ease-in-out`}
                                style={{
                                    transform: isOpen || isHovered ? 'rotate(45deg)' : 'rotate(0deg)',
                                    filter: isOpen || isHovered 
                                        ? 'brightness(0) saturate(100%) invert(32%) sepia(89%) saturate(2768%) hue-rotate(338deg) brightness(99%) contrast(92%)' 
...
export const About = () => {
    ...
    return (
        ...
        <div className='left-side-line w-[1px] h-[100%] absolute left-[31px] md:left-[31px] z-[100] top-[0px] overflow-hidden' aria-hidden>
            <div className='left-side-line-inner w-full h-full bg-[#FFFFFF33] origin-top' />
        </div>
        <div className='right-side-line w-[1px] h-[100%] absolute right-[31px] md:right-[31px] z-[100] top-[0px] overflow-hidden' aria-hidden>
