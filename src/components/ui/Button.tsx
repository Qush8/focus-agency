...
interface ButtonProps {
    ...
    galaxyMode?: boolean;
    arrowIcon?: boolean;
    galaxyTopCircleCss?: string;
    galaxyBottomCircleCss?: string;
}

export const Button : React.FC<ButtonProps> = ({ text, onClick, css = '', galaxyMode, arrowIcon, galaxyTopCircleCss = '', galaxyBottomCircleCss = '' }) => {
    return (
        <Fragment>
            ...
            <div className={`for-button-animation relative group ${galaxyMode &&  'pt-[20px] pb-[15px]'}`}>
                ...
                {galaxyMode && (
                    <div className={twMerge('w-[10px] h-[10px] absolute left-[15%] min-[431px]:bottom-[28px] bottom-[20px] rounded-full shadow-[0_0_10px_5px_var(--tw-shadow-color,#ffffffe6)] min-[431px]:shadow-[0_0_20px_10px_rgba(255,255,255,0.9)] z-[-1] transition-all duration-300 ease-in-out ', galaxyBottomCircleCss)}></div>
                )}
